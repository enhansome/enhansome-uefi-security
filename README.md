...
* [uefi-rs](https://github.com/rust-osdev/uefi-rs) ⭐ 1,651 | 🐛 36 | 🌐 Rust | 📅 2026-09-11
* [UEFI-Lessons](https://github.com/Kostr/UEFI-Lessons) ⭐ 369 | 🐛 1 | 🌐 C | 📅 2024-03-05
* [arch-secure-boot](https://github.com/maximbaz/arch-secure-boot) ⭐ 146 | 🐛 3 | 🌐 Shell | 📅 2024-07-18
* [edk2-libc](https://github.com/tianocore/edk2-libc) ⭐ 136 | 🐛 20 | 🌐 Python | 📅 2026-09-10
* [edk2-pytool-library](https://github.com/tianocore/edk2-pytool-library) ⭐ 67 | 🐛 17 | 🌐 Python | 📅 2026-09-07
...
* [PciLeech](https://github.com/ufrisk/pcileech) ⭐ 7,913 | 🐛 9 | 🌐 C | 📅 2026-07-25: PciLeech supports DMA attacks against UEFI, and it contains a mode can hook UEFI Runtime Services and print some chars.
* [qiling](https://github.com/qilingframework/qiling) ⭐ 6,097 | 🐛 110 | 🌐 Python | 📅 2026-09-13: Qiling has an EFI mode, which can partially emulate UEFI binary files.
* [UEFITool](https://github.com/LongSoft/UEFITool) ⭐ 5,670 | 🐛 23 | 🌐 C | 📅 2026-07-29: Tool for parsing and extracting UEFI firmware images.
* [Chipsec](https://github.com/chipsec/chipsec) ⭐ 3,299 | 🐛 49 | 🌐 Python | 📅 2026-09-12: The most commonly used tool for extracting UEFI firmware and exploiting UEFI vulnerabilities.
* [EfiGuard](https://github.com/Mattiwatti/EfiGuard) ⭐ 2,531 | 🐛 20 | 🌐 C++ | 📅 2026-06-16
* [uefi-rs](https://github.com/rust-osdev/uefi-rs) ⭐ 1,651 | 🐛 36 | 🌐 Rust | 📅 2026-09-11: A rust wrapper for UEFI. You can built UEFI applications and vulnerabilities PoCs easily with this library.
* [innoextract](https://github.com/dscharrer/innoextract) ⭐ 1,364 | 🐛 72 | 🌐 C++ | 📅 2025-02-06: A tool to unpack installers created by Inno Setup
...
* [BIOSUtiities](https://github.com/platomav/BIOSUtilities) ⭐ 1,087 | 🐛 2 | 🌐 Python | 📅 2025-07-01: A lot of scripts to parse and extract UEFI firmware images directly from exe files.
...
* [tsffs](https://github.com/intel/tsffs) ⭐ 331 | 🐛 33 | 🌐 Rust | 📅 2026-09-11: A snapshotting, coverage-guided fuzzer for software (UEFI, Kernel, firmware, BIOS) built on SIMICS, released by Intel.
