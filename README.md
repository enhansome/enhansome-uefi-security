...
* [PciLeech](https://github.com/ufrisk/pcileech) ⭐ 7,894 | 🐛 9 | 🌐 C | 📅 2026-07-25: PciLeech supports DMA attacks against UEFI, and it contains a mode can hook UEFI Runtime Services and print some chars.
* [qiling](https://github.com/qilingframework/qiling) ⭐ 6,069 | 🐛 123 | 🌐 Python | 📅 2026-07-22: Qiling has an EFI mode, which can partially emulate UEFI binary files.
...
* [innoextract](https://github.com/dscharrer/innoextract) ⭐ 1,340 | 🐛 69 | 🌐 C++ | 📅 2025-02-06: A tool to unpack installers created by Inno Setup
* [efiXplorer](https://github.com/binarly-io/efiXplorer) ⭐ 1,123 | 🐛 0 | 🌐 C++ | 📅 2026-08-20: IDA Pro plugin, the best plugin for analyzing UEFI binaries for now.
